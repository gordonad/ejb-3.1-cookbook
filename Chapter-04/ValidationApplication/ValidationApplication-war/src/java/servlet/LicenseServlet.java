...
//    @PersistenceContext(unitName = "ValidationApplication-warPU", type = PersistenceContextType.EXTENDED)
    // ValidationApplication-warPU persistence.xml file was removed accidentally
    LicenseBean license;
...
//            Iterator iter = constraintViolations.iterator();
//            while (iter.hasNext()) {
//                out.println("<h3>Name: " + iter.next() + "</h3>");
//            }
        } finally {
            out.close();
        }
