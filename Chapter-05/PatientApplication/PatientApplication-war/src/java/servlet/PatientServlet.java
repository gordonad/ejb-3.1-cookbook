...
//            out.println("<h3>Patient count: " + count + "</h3>");
//
            medicationFacade.displayAll(out);
//            for (Patient pe : patientList) {
//
//                Calendar calendar = Calendar.getInstance();
//                calendar.setTime(pe.getDateOfBirth());
//                String date;
//                date = calendar.get(Calendar.MONTH) + "/"
//                        + calendar.get(Calendar.DAY_OF_MONTH) + "/"
//                        + calendar.get(Calendar.YEAR);
//                out.println("<h3>Patient: " + pe.getId() + " - "
//                        + pe.getFirstName() + " " + pe.getLastName()
//                        + " - " + date + "</h3>");
//            }
//
//            List<String> firstNameList1 = patientFacade.findAllFirstNames();
//            for (String name : firstNameList1) {
//                out.println("<h5>Patient First Name: " + name + "</h5>");
//            }
//
