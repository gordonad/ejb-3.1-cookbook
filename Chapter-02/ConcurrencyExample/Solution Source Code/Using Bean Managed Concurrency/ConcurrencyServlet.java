...
//            simulationBeanManaged.setState(SimulationBeanManaged.State.PAUSED);
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h3>Simulation Container Managed State: " + simulationContainerManaged.getState() + "</h3>");
//            out.println("<h3>Simulation Bean Managed State: " + simulationBeanManaged.getState() + "</h3>");
            out.println("</body>");
            out.println("</html>");
